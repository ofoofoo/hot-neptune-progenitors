...
for _ in range(1):
    ...
    n_between_writeouts = int((integrationtime / time_between_outputs) / 2)
    ...
    for i,time in enumerate(times):
      ...
      if i % n_between_writeouts == 0 and i != 0: # writeout to .npy periodically every n times we update orbitalelements (note that this != every n timesteps!)
      	np.save(filename, orbitalelementsdict["orbitalelements"])
      #print("dt: " + str(sim.dt))
...
#np.savetxt(file1, orbitalelementsdict["orbitalelements"])
# instead of write, use np.savetxt(orbitalelementsdict["orbitalelements"]) *********************************
#filtered_orbitalelm = []
